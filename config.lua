Config = {
    ...
    -- Arabic Banking System Configuration
    enableArabic = true, -- تم تفعيل اللغة العربية وتخطيط RTL
    
    -- إعدادات نظام القروض
    enableLoans = false, -- ميزة القروض معطلة
    
    -- إعدادات رئيس الشرطة (تستخدم لميزات أخرى)
    policeChiefJobs = {
        ["police"] = 4, -- رتبة رئيس الشرطة
        ["sheriff"] = 4 -- رتبة رئيس الشريف
    }
}
